...
public class Terapium {
    ...
    @Expose
    private List<RevisionLog> revisionLog = null;
    ...
    @Expose
    private List<Object> contentTranslationSource = null;
    ...
    public List<RevisionLog> getRevisionLog() {
        return revisionLog;
    }

    public void setRevisionLog(List<RevisionLog> revisionLog) {
    ...
    public List<Object> getContentTranslationSource() {
        return contentTranslationSource;
    }

    public void setContentTranslationSource(List<Object> contentTranslationSource) {
